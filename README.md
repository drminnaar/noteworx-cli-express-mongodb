...
A basic note application that uses a CLI (Command Line Interface) frontend to capture and manage notes, a note management API built in [Express](https://expressjs.com/), and [MongoDB](https://www.mongodb.com/) to store notes.
...
![noteworx-cli-express-mongodb](https://user-images.githubusercontent.com/33935506/33574385-944f9d52-d941-11e7-826a-e4395e4c829b.PNG)
...
I use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/drminnaar/noteworx-cli-express-mongodb/tags).
